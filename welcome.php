...
<body>
    ...
    <div class="container mt-3">
        <div class="alert alert-success" role="alert">
            <h4 class="alert-heading">Hello <?php echo $_SESSION[
                'userName'
            ]; ?>, Welcome to iSecure...</h4>
            ...
            <hr>
            <p class="mb-0">Whenever you need to, be sure to logout <a href="/PHPtutorial/loginSys/logout.php"> using
                    this link</a> </p>
        </div>
    </div>
